...
((SELECT id FROM rti_requests WHERE title = 'Inquiry on Hospital Supplies' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'APPROVED' LIMIT 1), 'sent', 'Request approved by the designated official.', NOW() - INTERVAL '9 days', NOW() - INTERVAL '8 days', '[]'),
((SELECT id FROM rti_requests WHERE title = 'Inquiry on Hospital Supplies' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'SENT_TO_RECEIVER' LIMIT 1), 'sent', 'Request officially forwarded to the Ministry of Health.', NOW() - INTERVAL '8 days', NULL, '[]');
...
((SELECT id FROM rti_requests WHERE title = 'School Expenditure 2024' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'APPROVED' LIMIT 1), 'sent', 'Verified and approved.', NOW() - INTERVAL '17 days', NOW() - INTERVAL '16 days', '[]'),
((SELECT id FROM rti_requests WHERE title = 'School Expenditure 2024' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'SENT_TO_RECEIVER' LIMIT 1), 'sent', 'Sent to Dept of Education.', NOW() - INTERVAL '16 days', NOW() - INTERVAL '5 days', '[]'),
...
((SELECT id FROM rti_requests WHERE title = 'Highway Project Budget' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'APPROVED' LIMIT 1), 'sent', 'Internal approval granted.', NOW() - INTERVAL '14 days', NOW() - INTERVAL '13 days', '[]'),
((SELECT id FROM rti_requests WHERE title = 'Highway Project Budget' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'SENT_TO_RECEIVER' LIMIT 1), 'sent', 'Forwarded to RDA.', NOW() - INTERVAL '13 days', NOW() - INTERVAL '10 days', '[]'),
...
((SELECT id FROM rti_requests WHERE title = 'Environmental Clearance List' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'APPROVED' LIMIT 1), 'sent', 'Approved by Senior Secretary.', NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 hour', '[]'),
((SELECT id FROM rti_requests WHERE title = 'Environmental Clearance List' LIMIT 1), (SELECT id FROM rti_statuses WHERE name = 'SENT_TO_RECEIVER' LIMIT 1), 'sent', 'Emailed to CEA.', NOW() - INTERVAL '1 hour', NULL, '[]');
